...
class CartController extends Controller
{
    ...
    private function buildCartRows(
        int $storeId
    ): array {
        $cartItems =
            $this->cart->items($storeId);
