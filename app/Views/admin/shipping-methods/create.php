...
<div class="shipping-form-page">
    <header class="shipping-form-header">
        <div>
            ...
            <p>
                Add a checkout delivery option for
    ...
    <section class="shipping-form-panel">
        <form
            method="POST"
            action="/admin/stores/<?= $escape($store['id']) ?>/shipping-methods"
        >
            <input
                type="hidden"
                name="_csrf_token"
            ...
            <div class="shipping-form-grid">
                ...
                <div class="shipping-form-group">
                    ...
                    >
                    <small>
                        Leave blank to generate the code from the method name.
                    </small>
                </div>
                ...
                <div class="shipping-form-group">
                    ...
                    <input
                        ...
                        value="<?= $escape($old['estimated_days_min'] ?? '') ?>"
                        min="0"
                        step="1"
                        inputmode="numeric"
                        placeholder="5"
                ...
                <div class="shipping-form-group">
                    ...
                    <input
                        ...
                        value="<?= $escape($old['estimated_days_max'] ?? '') ?>"
                        min="0"
                        step="1"
                        inputmode="numeric"
                        placeholder="7"
