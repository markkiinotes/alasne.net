...
<div class="payment-form-page">
    <header class="payment-form-header">
        <div>
            ...
            <p>
                Add a simulated checkout option for
                <strong>
                    <?= $escape($store['name']) ?>
                </strong>.
            </p>
        ...
        >
            ...
            <div class="payment-form-grid">
                ...
                <div class="payment-form-group">
                    ...
                    <small>
                        Leave blank to generate it from
                        the display name.
                    </small>
                </div>
                ...
                >
                    ...
                    ><?= $escape(
                        $old['instructions']
                        ?? 'Choose Approved, Declined, or Provider Error to test the order-payment lifecycle.'
                    ) ?></textarea>
                </div>
