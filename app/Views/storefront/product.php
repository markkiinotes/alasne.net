...
<header class="storefront-product-header">
    <div class="storefront-container storefront-topbar">
        ...
        <a
            href="/store/<?= htmlspecialchars($store['slug']) ?>/cart"
            class="cart-link"
        >
            Cart <?= (int) ($cartQuantity ?? 0) > 0
                ? '('
                    . htmlspecialchars(
                        (string) $cartQuantity
                    )
    ...
    <section class="product-detail-layout">
        ...
        <div class="product-detail-info">
            ...
            <div class="product-detail-price-row">
                ...
                <span
                    class="stock-pill <?= htmlspecialchars(
                        $stockClass
                    ) ?>"
                >
            ...
            <div class="product-detail-actions">
                ...
                <?php else: ?>
                    <button
                        class="storefront-cart-button disabled"
                        type="button"
                        disabled
                    >
    ...
    <?php if (! empty($relatedProducts)): ?>
        <section class="storefront-section">
            <div class="section-header">
                ...
                <p>
                    Other products available in this storefront.
                </p>
            </div>
            ...
            <div class="product-grid">
                <?php foreach (
                    ...
                    <?php include BASE_PATH
                        . '/app/Views/storefront/partials/product-card.php'; ?>
                <?php endforeach; ?>
            </div>
        </section>
    <?php endif; ?>
